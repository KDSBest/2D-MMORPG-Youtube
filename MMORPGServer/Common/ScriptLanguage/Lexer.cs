...
namespace Common.ScriptLanguage
{
	...
	public class Lexer
    {
        ...
        private string[] reservedWords = { "function", "class",
        ...
        private bool IsCharInTokenList(char c, char[] tokens)
        {
        ...
        private char GetEscapreSequenze(char c)
        {
